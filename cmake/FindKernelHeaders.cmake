...
if ( NOT KERNELHEADERS_LATEST )
	...
	foreach ( KERNEL_PATH ${KERNEL_PATHS} )
		string(REGEX MATCH "[0-9]+.[0-9]+.[0-9]+-[0-9]+" KERNEL_VERSION ${KERNEL_RELEASE})
		file(GLOB KERNEL_RELEASE_PATH "${KERNEL_PATH}${KERNEL_VERSION}*")
		list(APPEND KERNEL_RELEASE_PATHS "${KERNEL_RELEASE_PATH}")
